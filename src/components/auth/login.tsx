...
const Login = () => {
  ...
  return (
    <div className="min-h-screen py-10 mb-5 rounded gap-4 flex items-center justify-center relative overflow-hidden bg-gradient-to-br from-cyan-900 via-slate-900 to-indigo-900 dark:bg-gray-900" style={{margin:"0px", display: "flex", flexDirection:"column"}}>
    {/* <ThemeSwitch />  -----EN DESARROLLO PARA EL COMPONENTE LOGIN.*/} 
    ...
    >
      <Card className="p-8 backdrop-blur-xl bg-white/10 shadow-2xl rounded-3xl">
        ...
        <div className="mt-6 text-center" style={{display:"flex", flexDirection: "column", alignItems:"center"}}>
          <Link href="#" className="text-sm text-white hover:underline">
            ¿Olvidaste tu contraseña?
          </Link>
          <Divider className="my-4 bg-default" />
          <Link isBlock showAnchorIcon href="/main_auth" color="primary" className="color:default p-3">
            Regresar
          </Link>
        </div>
      </Card>
